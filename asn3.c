...
int flag=0; int i=0;int l=0;int m=0;int f=0;int h=0;
char username[20], password[20];int v=0;const int rz;
char buffer[25];char *fvalue= NULL,*lvalue= NULL,lFlag=0;
char temp[500];char line[100];
int system(const char *command);
//static PyObject *result11;
...
//rz=syscall("python3 upgrade.py");
//result11 = PyObject_CallObject(upgrade);
//PyEval_CallObject(upgrade);
